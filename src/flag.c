...
const char *usage = "Laser- a command line utility to assemble LC3 assembly code\n\n"
                    ...
                    "\t'laser -d <file>' to assemble a file && debug files\n"
                    "\t'laser -c <file>' to remove all files generated by 'laser -d <file>'\n";
...
const char *help = "Usage:\n"
                    ...
                    "\t-d: 'laser -d <file>' outputs debug files && assembles specified file\n"
                    "\t    'laser -d *.asm' outputs debug files && assembles all files in current directory\n"
                    ...
                    "\t-c: 'laser -c <file>' removes all files generated during debug generation\n";

const char *flags[] = { "-v", "-h", "-q", "-s", "-a", "-d", "-c", "-l", "-p"};
